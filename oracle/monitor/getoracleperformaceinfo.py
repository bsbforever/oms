...
def getbuffergets_9i(cursor):
    fp=open('/home/oms/oms/oracle/monitor/oracle_performance/getbuffergets_9i.sql','r') 
    fp1=fp.read()
...
def getdiskreads_9i(cursor):
    fp=open('/home/oms/oms/oracle/monitor/oracle_performance/getdiskreads_9i.sql','r') 
    fp1=fp.read()
    s=cursor.execute(fp1)
    fp.close()
    row=s.fetchall()
...
def getelapsedtime_9i(cursor):
    fp=open('/home/oms/oms/oracle/monitor/oracle_performance/getelapsedtime_9i.sql','r') 
    fp1=fp.read()
    s=cursor.execute(fp1)
    fp.close()
    row=s.fetchall()
...
def gettemputilization(cursor):
    fp=open('/home/oms/oms/oracle/monitor/oracle_performance/gettempusage.sql','r') 
    fp1=fp.read()
    s=cursor.execute(fp1)
    fp.close()
    row=s.fetchone()
...
def gettempusagetext(cursor):
    fp=open('/home/oms/oms/oracle/monitor/oracle_performance/gettempusagetext.sql','r') 
    fp1=fp.read()
    s=cursor.execute(fp1)
    fp.close()
    row=s.fetchall()
...
def getundousage(cursor):
    fp=open('/home/oms/oms/oracle/monitor/oracle_performance/getundousage.sql','r') 
    fp1=fp.read()
    s=cursor.execute(fp1)
    fp.close()
    row=s.fetchone()
...
def getlibhit(cursor):
    fp=open('/home/oms/oms/oracle/monitor/oracle_performance/getlibhit.sql','r') 
    fp1=fp.read()
    s=cursor.execute(fp1)
    fp.close()
    row=s.fetchone()
...
def getdichit(cursor):
    fp=open('/home/oms/oms/oracle/monitor/oracle_performance/getdichit.sql','r') 
    fp1=fp.read()
    s=cursor.execute(fp1)
    fp.close()
    row=s.fetchone()
...
def getcachehit(cursor):
    fp=open('/home/oms/oms/oracle/monitor/oracle_performance/getcachehit.sql','r') 
    fp1=fp.read()
    s=cursor.execute(fp1)
    fp.close()
    row=s.fetchone()
...
def getsqlplan(cursor):
    fp=open('/home/oms/oms/oracle/monitor/oracle_performance/sql_plan_9i.sql','r') 
    fp1=fp.read()
    s=cursor.execute(fp1)
    fp.close()
    row=s.fetchall()
...
def gettopsegment(cursor):
    fp=open('/home/oms/oms/oracle/monitor/oracle_performance/gettopsegment.sql','r') 
    fp1=fp.read()
    s=cursor.execute(fp1)
    fp.close()
    row=s.fetchall()
